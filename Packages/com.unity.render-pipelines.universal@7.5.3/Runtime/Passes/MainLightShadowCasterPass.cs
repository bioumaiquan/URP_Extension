    ...
    public class MainLightShadowCasterPass : ScriptableRenderPass
    {
        ...
        void RenderMainLightCascadeShadowmap(ref ScriptableRenderContext context, ref CullingResults cullResults, ref LightData lightData, ref ShadowData shadowData)
        {
            ...
            using (new ProfilingScope(cmd, m_ProfilingSampler))
            {
                ...
                SetupMainLightShadowReceiverConstants(cmd, shadowLight, shadowData.supportsSoftShadows, ref shadowData);
            }
        ...
        void SetupMainLightShadowReceiverConstants(CommandBuffer cmd, VisibleLight shadowLight, bool supportsSoftShadows, ref ShadowData shadowData)
        {
            Light light = shadowLight.light;
            ...
            cmd.SetGlobalVector(MainLightShadowConstantBuffer._ShadowParams,
                new Vector4(light.shadowStrength, softShadowsProp, 1.0f / Mathf.Max(0.001f, shadowData.shadowDistance), 1.0f / Mathf.Max(0.001f, shadowData.shadowFade)));
            // Marked by Bioum
