...
public class UVPreview
{
    ...
    private static Material CheckerBoardMaterial
    {
        get
        {
            ...
            {
                sCheckerBoardMaterial = new Material(kCheckerBoardShader);
    ...
    private static Material UVMaterial
    {
        get
        {
            if (sUVMaterial == null)
            {
                sUVMaterial = new Material(kUVShader);
    ...
    private static Mesh CheckerBoard
    {
        get
        {
            if (sCheckerBoard == null)
            {
                ...
                sCheckerBoard.vertices = new Vector3[] { new Vector3(0, 0, 0), new Vector3(0, 1, 0), new Vector3(1, 1, 0), new Vector3(1, 0, 0) };
                sCheckerBoard.uv = new Vector2[] { new Vector2(0, 0), new Vector2(0, 1), new Vector2(1, 1), new Vector2(1, 0) };
    ...
    private static Shader kCheckerBoardShader = Shader.Find("Hidden/Internal/GUI/CheckerBoard");
    private static Shader kUVToTextureShader = Shader.Find("Hidden/Internal/UVPreview/UVToTexture");
    private static Shader kUVShader = Shader.Find("Hidden/Internal/GUI/UVRender");
    ...
    public static Texture2D RenderUV(GameObject gameObject, int uvIndex, Color color)
    {
        ...
        Material renderMat = new Material(kUVToTextureShader);
